...
from info import CHANNELS, ADMINS, AUTH_CHANNEL, REQ_CHANNEL, JOIN_REQS_DB, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, MAX_B_TN, IS_VERIFY, HOW_TO_VERIFY
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          ...
                          InlineKeyboardButton("🎬 New Movies 🎬", url="https://t.me/NewMoviez2023")
                         ]
                        ]
                    )
                )
